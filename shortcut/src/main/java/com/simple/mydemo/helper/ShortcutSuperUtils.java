package com.simple.mydemo.helper;
...
//                    new String[]{title, intent.toUri(0)}, null);
            ...
            Log.e("Simple", "---------- c.getColumnCount() : " + c.getColumnCount());
            while (c.moveToNext()) {
                Log.e("Simple", "------ Column 0  " + c.getString(0)
                        + "                 Column 1  " + c.getString(1)
                        + "                 Column 2  " + c.getString(2)
                        + "                 Column 3  " + c.getString(3)

                );

//                for (int i = 0; i < c.getColumnCount(); i++) {
//                    Log.e("Simple", "------ Column  " + i + " : " + c.getString(i));
//                }
            }
